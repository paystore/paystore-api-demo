...
import br.com.phoebus.android.payments.demo.fragments.CursorUtils;
...
public class TerminalInfoActivity extends AppCompatActivity {
    ...
    TextView merchantId, merchantName, merchantCommercialName, terminalId, nationalId, postalCode, street, city, state, stateAbbreviation, country,
            complement, neighbourhood, addressNumber, merchantWebsite, merchantEmail, merchantPhone, merchantCategoryCode, merchantNationalType, subAcquirerId, mainApp, serialNumber;
    ...
    private void setTerminalInformation() {
        ...
        if (!CursorUtils.isEmpty(terminalInformationCursor) && terminalInformationCursor.moveToFirst()) {
            ...
            serialNumber.setText(CursorUtils.getString(terminalInformationCursor, TerminalInfoContract.column.SERIAL_NUMBER));
        }
    }
